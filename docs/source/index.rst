...
TornadoVM is a GPU programming framework for Java (JDK 21+, including JDK 21 and JDK 25) that JIT-compiles Java bytecode at runtime to **NVIDIA CUDA C, OpenCL C, SPIR-V, and Apple Metal (MSL)**.
