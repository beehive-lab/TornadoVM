...
The up-to-date, actively-maintained list of talks, conference videos and podcast episodes is kept on the official website, not here:

`tornadovm.org/talks <https://www.tornadovm.org/talks>`__

Blog
--------

The up-to-date list of articles and blog posts is kept on the official website, not here:

`tornadovm.org/blogs <https://www.tornadovm.org/blogs>`__
