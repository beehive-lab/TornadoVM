...
TornadoVM targets devices compatible with OpenCL, CUDA, Level Zero, and Apple Metal, which include multi-core CPUs,
...
TornadoVM does not replace existing VMs, but it rather complements them with the capability of offloading Java code to OpenCL, CUDA, SPIR-V and Metal,
