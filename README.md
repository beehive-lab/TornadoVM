...
See the [Install](https://github.com/beehive-lab/tornado/blob/master/assembly/src/docs/1_INSTALL.md) file for details about how to install tornado and run Java programs on GPUs and FPGAs. 
