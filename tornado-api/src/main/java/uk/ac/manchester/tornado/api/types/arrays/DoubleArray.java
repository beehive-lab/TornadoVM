 ...
 * encapsulates methods for setting and getting double values, for initializing the double array, and for converting the array to and from different representations.
 */
...
public final class DoubleArray extends TornadoNativeArray {
    ...
    /**
     * Constructs a new instance of the {@link DoubleArray} by wrapping an existing {@link MemorySegment} without copying its contents.
     *
    ...
    /**
     * Creates a new instance of the {@link DoubleArray} class by wrapping an existing {@link MemorySegment} without copying its contents.
     *
     * @param segment
     *         The {@link MemorySegment} containing *both* the off-heap double *header* and *data*.
    ...
    /**
     * Converts the double data from off-heap to on-heap, by copying the values of a {@link DoubleArray} instance into a new on-heap array.
     *
    ...
    /**
     * Returns the number of bytes of the {@link MemorySegment} that is associated with the {@link DoubleArray} instance, excluding the header bytes.
     *
