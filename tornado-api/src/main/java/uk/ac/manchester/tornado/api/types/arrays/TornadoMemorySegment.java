...
public class TornadoMemorySegment {
    ...
    public TornadoMemorySegment(MemorySegment existingSegment, int baseIndex) {
    ...
    public boolean getBooleanAtIndex(int index, int baseIndex) {
        return segment.getAtIndex(ValueLayout.JAVA_BOOLEAN, baseIndex + index);
    }
    /**
