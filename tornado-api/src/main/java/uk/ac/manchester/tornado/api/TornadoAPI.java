...
public interface TornadoAPI {
    ...
    public TornadoAPI prebuiltTask(String id, String entryPoint, String filename, Object[] args, Access[] accesses, GenericDevice device, int[] dimensions);

    public String getTaskScheduleName();

    public TornadoAPI task(SchedulableTask task);

    public TornadoAPI mapAllTo(GenericDevice device);
