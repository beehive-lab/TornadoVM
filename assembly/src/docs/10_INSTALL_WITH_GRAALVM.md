# Installing TornadoVM with GraalVM 21.1.0
...
#### 1 Download GraalVM Community Edition 21.1.0

GraalVM 21.1.0 builds are available to download at [https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-21.1.0](https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-21.1.0).
...
The Java binary will be found in the `graalvm-ce-java{JDK_VERSION}-21.1.0` directory. This directory is used as the JAVA_HOME (See step 2).
...
```bash
#!/bin/bash
export JAVA_HOME=<path to GraalVM 21.1.0 jdk> ## This path is produced in Step 1
