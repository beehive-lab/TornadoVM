...
__TEST_THE_WORLD__ = [
    ...
    TestEntry("uk.ac.manchester.tornado.unittests.matrices.TestMatrixMultiplicationTornadoVMContext"),
    ...
    TestEntry("uk.ac.manchester.tornado.unittests.reductions.TestReductionsIntegersTornadoVMContext"),
    TestEntry("uk.ac.manchester.tornado.unittests.reductions.TestReductionsFloatsTornadoVMContext"),
    TestEntry("uk.ac.manchester.tornado.unittests.reductions.TestReductionsDoublesTornadoVMContext"),
    TestEntry("uk.ac.manchester.tornado.unittests.reductions.TestReductionsLongTornadoVMContext"),
    ...
    TestEntry("uk.ac.manchester.tornado.unittests.api.TestCombinedTaskSchedule"),
