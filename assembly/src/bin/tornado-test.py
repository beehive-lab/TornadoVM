...
__TEST_THE_WORLD__ = [
    ...
    TestEntry("uk.ac.manchester.tornado.unittests.tornadovmcontext.reductions.TestReductionsDoublesTornadoVMContext"),
    TestEntry("uk.ac.manchester.tornado.unittests.tornadovmcontext.reductions.TestReductionsLongTornadoVMContext"),
