...
__TEST_THE_WORLD__ = [
	...
	"uk.ac.manchester.tornado.unittests.api.TestIntegerReductionsTornadoVMContextApi",
	"uk.ac.manchester.tornado.unittests.api.TestLongReductionsTornadoVMContextApi",
	"uk.ac.manchester.tornado.unittests.api.TestFloatReductionsTornadoVMContextApi",
	"uk.ac.manchester.tornado.unittests.api.TestDoubleReductionsTornadoVMContextApi",
