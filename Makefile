...
jdk-8:
	./bin/compile jdk-8 $(BACKENDS)

build jdk-11-plus:
	./bin/compile jdk-11-plus $(BACKENDS)

graal-jdk-11-plus:
	./bin/compile graal-jdk-11-plus $(BACKENDS)

ptx:
	./bin/compile jdk-11-plus BACKENDS=ptx,opencl

spirv:
	./bin/compile jdk-11-plus BACKENDS=spirv,ptx,opencl

offline:
	./bin/compile jdk-11-plus $(BACKENDS) OFFLINE
