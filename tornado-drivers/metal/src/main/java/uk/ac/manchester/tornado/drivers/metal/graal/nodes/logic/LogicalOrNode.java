...
import static uk.ac.manchester.tornado.drivers.metal.graal.asm.MetalAssembler.MetalBinaryOp.LOGICAL_OR;
...
public class LogicalOrNode extends BinaryLogicalNode {
    ...
    public Value generate(LIRGeneratorTool tool, Value x, Value y) {
        ...
        AssignStmt assign = new AssignStmt(result, new MetalBinary.Expr(LOGICAL_OR, tool.getLIRKind(stamp), x, y));
        tool.append(assign);
        return result;
    }
}
