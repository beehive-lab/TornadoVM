...
public interface MetalTargetDevice extends TornadoTargetDevice {
    ...
    String getDeviceMetalCVersion();

    boolean isLittleEndian();

    MetalDeviceContextInterface getDeviceContext();

    void setDeviceContext(MetalDeviceContextInterface deviceContext);
