 ...
 *
 * <p>
 * {@link jdk.graal.compiler.phases.common.FloatingReadPhase}
 * </p>
 */
public class TornadoFloatingReadReplacement extends PostRunCanonicalizationPhase<CoreProviders> {
    ...
    public static class FloatingReadClosure extends ReentrantNodeIterator.NodeIteratorClosure<TornadoFloatingReadReplacement.MemoryMapImpl> {
        ...
        /**
         * @param accessNode
         *     is a {@link FixedNode} that will be replaced by a {@link FloatingNode}. This method checks if the node that is going to be replaced has an {@link MetalBarrierNode} as next.
         */
        private static boolean isNextNodeMetalBarrierNode(FloatableAccessNode accessNode) {
            return (accessNode.next() instanceof MetalBarrierNode);
        }

        /**
         * @param nextNode
         *     is a {@link FixedNode} that will be replaced by a {@link FloatingNode}. This method removes the redundant {@link MetalBarrierNode}.
         */
        ...
        private void processFloatable(FloatableAccessNode accessNode, TornadoFloatingReadReplacement.MemoryMapImpl state) {
            ...
            if (accessNode.canFloat() && shouldBeFloatingRead(accessNode)) {
                ...
                try (DebugCloseable position = accessNode.withNodeSourcePosition()) {
                    ...
                    if (isNextNodeMetalBarrierNode(accessNode)) {
