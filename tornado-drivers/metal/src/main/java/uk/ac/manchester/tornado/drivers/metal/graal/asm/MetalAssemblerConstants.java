...
public class MetalAssemblerConstants {

    public static final String KERNEL_MODIFIER = "kernel";
    public static final String EOL = "\n";
    // Metal address-space qualifiers
    public static final String GLOBAL_MEM_MODIFIER = "device";
    public static final String SHARED_MEM_MODIFIER = "threadgroup"; // equivalent to shared/local
    public static final String LOCAL_MEM_MODIFIER = "threadgroup";
    public static final String PRIVATE_MEM_MODIFIER = "thread";
    public static final String CONSTANT_MEM_MODIFIER = "constant";
