...
import static uk.ac.manchester.tornado.drivers.metal.scheduler.MetalFPGAScheduler.DEFAULT_LOCAL_WORK_SIZE;

import java.util.Arrays;

import uk.ac.manchester.tornado.drivers.common.GridInfo;

public class MetalGridInfo implements GridInfo {
    MetalDeviceContext deviceContext;
    public final long[] localWork;

    public MetalGridInfo(MetalDeviceContext deviceContext, long[] localWork) {
