...
public class AtomicAddNodeTemplate extends FixedWithNextNode implements LIRLowerable {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        tool.append(new MetalLIRStmt.AssignStmt(result, new MetalUnary.Intrinsic(MetalAssembler.MetalUnaryIntrinsic.ATOMIC_ADD, tool.getLIRKind(stamp), gen.operand(inc))));
