...
public class MetalIntArrayWrapper extends MetalArrayWrapper<int[]> {

    public MetalIntArrayWrapper(MetalDeviceContext device, long batchSize, Access access) {
        super(device, JavaKind.Int, batchSize, access);
    }

    protected MetalIntArrayWrapper(int[] array, final MetalDeviceContext device, long batchSize, Access access) {
    ...
    public int getSizeOfType() {
        return MetalKind.INT.getSizeInBytes();
    }
