...
public class MetalCompilationResultBuilder extends CompilationResultBuilder {
    ...
    public MetalCompilationResultBuilder(CodeGenProviders providers, FrameMap frameMap, Assembler asm, DataBuilder dataBuilder, FrameContext frameContext, OptionValues options, DebugContext debug,
    ...
    public void emit(LIR lir) {
        ...
        traverseControlFlowGraph(cfg, new MetalBlockVisitor(this));
    ...
    private void traverseControlFlowGraph(ControlFlowGraph cfg, MetalBlockVisitor visitor) {
    ...
    private void rescheduleBasicBlock(HIRBlock basicHIRBlock, MetalBlockVisitor visitor, HashSet<HIRBlock> visited, HashMap<HIRBlock, HIRBlock> pending) {
     ...
     *     {@link HIRBlock}
     * @param visitor
     *     {@link MetalBlockVisitor}
     * @param visited
     *     {@link HashSet}
     * @param pending
     *     {@link HashMap}
     */
    private void rescheduleTrueBranchConditionsIfNeeded(HIRBlock basicBlock, MetalBlockVisitor visitor, HashSet<HIRBlock> visited, HashMap<HIRBlock, HIRBlock> pending) {
    ...
    private void traverseControlFlowGraph(HIRBlock basicBlock, MetalBlockVisitor visitor, HashSet<HIRBlock> visited, HashMap<HIRBlock, HIRBlock> pending) {
