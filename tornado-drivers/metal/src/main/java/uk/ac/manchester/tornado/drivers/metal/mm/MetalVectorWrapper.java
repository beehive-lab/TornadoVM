...
public class MetalVectorWrapper implements XPUBuffer {
    ...
    public MetalVectorWrapper(final MetalDeviceContext device, final Object object, long batchSize, Access access) {
