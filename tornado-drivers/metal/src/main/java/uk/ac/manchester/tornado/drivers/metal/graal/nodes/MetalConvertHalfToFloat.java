...
@NodeInfo
public class MetalConvertHalfToFloat extends ValueNode implements LIRLowerable {

    public static final NodeClass<MetalConvertHalfToFloat> TYPE = NodeClass.create(MetalConvertHalfToFloat.class);

    @Input
    private ValueNode halfValueNode;

    public MetalConvertHalfToFloat(ValueNode halfValueNode) {
    ...
    public void generate(NodeLIRBuilderTool generator) {
        ...
        tool.append(new MetalLIRStmt.ConvertHalfToFloatStmt(floatValue, halfValue));
