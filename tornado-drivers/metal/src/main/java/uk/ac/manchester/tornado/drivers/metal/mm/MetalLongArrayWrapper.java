...
public class MetalLongArrayWrapper extends MetalArrayWrapper<long[]> {

    public MetalLongArrayWrapper(MetalDeviceContext deviceContext, long batchSize, Access access) {
        super(deviceContext, JavaKind.Long, batchSize, access);
    }

    protected MetalLongArrayWrapper(final long[] array, final MetalDeviceContext device, long batchSize, Access access) {
        super(array, device, JavaKind.Long, batchSize, access);
    }
    ...
    public int getSizeOfType() {
        return MetalKind.LONG.getSizeInBytes();
    }
