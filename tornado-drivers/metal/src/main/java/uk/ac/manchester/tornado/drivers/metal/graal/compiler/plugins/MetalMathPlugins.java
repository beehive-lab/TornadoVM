...
public class MetalMathPlugins {
    ...
    private static void registerHalfFloatMathPlugins(Registration r) {
        r.register(new InvocationPlugin("min", HalfFloat.class, HalfFloat.class) {
            @Override
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode x, ValueNode y) {
                b.push(JavaKind.Object, b.append(MetalFPBinaryIntrinsicNode.create(x, y, FMIN, JavaKind.Short)));
                return true;
            }
        });
        ...
        r.register(new InvocationPlugin("max", HalfFloat.class, HalfFloat.class) {
            @Override
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode x, ValueNode y) {
                b.push(JavaKind.Object, b.append(MetalFPBinaryIntrinsicNode.create(x, y, FMAX, JavaKind.Short)));
                return true;
            }
        });
    }
