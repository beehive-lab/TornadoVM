...
public class MetalCharArrayWrapper extends MetalArrayWrapper<char[]> {

    public MetalCharArrayWrapper(MetalDeviceContext device, long batchSize, Access access) {
        super(device, JavaKind.Char, batchSize, access);
    }

    protected MetalCharArrayWrapper(final char[] array, final MetalDeviceContext device, long batchSize, Access access) {
    ...
    public int getSizeOfType() {
        return MetalKind.CHAR.getSizeInBytes();
    }
