...
public class CUDAShortArrayWrapper extends CUDAArrayWrapper<short[]> {
    ...
    public CUDAShortArrayWrapper(CUDADeviceContext deviceContext, long batchSize, Access access) {
        super(deviceContext, JavaKind.Short, batchSize, access);
    }

    protected CUDAShortArrayWrapper(final short[] array, final CUDADeviceContext device, long batchSize, Access access) {
    ...
    public int getSizeOfType() {
        return CUDAKind.SHORT.getSizeInBytes();
    }
