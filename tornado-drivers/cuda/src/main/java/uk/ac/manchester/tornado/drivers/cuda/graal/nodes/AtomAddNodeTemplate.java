...
public class AtomAddNodeTemplate extends FixedWithNextNode implements LIRLowerable {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        tool.append(new CUDALIRStmt.AssignStmt(result, new CUDAUnary.AtomOperation(CUDAAssembler.CUDAUnaryOp.CAST_TO_INT, tool.getLIRKind(stamp), gen.operand(address), (CUDAUnary.MemoryAccess) gen.operand(
                address), CUDAAssembler.CUDAUnaryIntrinsic.ATOM_ADD, gen.operand(inc))));
