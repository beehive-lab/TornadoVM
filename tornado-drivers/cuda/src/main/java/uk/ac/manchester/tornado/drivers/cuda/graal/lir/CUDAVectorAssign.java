...
import uk.ac.manchester.tornado.drivers.cuda.graal.asm.CUDAAssembler.CUDAOp;
...
public class CUDAVectorAssign {

    /**
     * CUDADriver vector assignment expression
     */
    public static class Assign2Expr extends CUDALIROp {

        @Opcode
        protected final CUDAOp opcode;
        ...
        public Assign2Expr(CUDAOp opcode, CUDAKind oclKind, Value s0, Value s1) {
    ...
    public static class Assign3Expr extends Assign2Expr {
        ...
        public Assign3Expr(CUDAOp3 opcode, CUDAKind kind, Value s0, Value s1, Value s2) {
    ...
    public static class Assign4Expr extends Assign3Expr {
        ...
        public Assign4Expr(CUDAOp4 opcode, CUDAKind kind, Value s0, Value s1, Value s2, Value s3) {
    ...
    public static class Assign8Expr extends Assign4Expr {
        ...
        public Assign8Expr(CUDAOp8 opcode, CUDAKind kind, Value s0, Value s1, Value s2, Value s3, Value s4, Value s5, Value s6, Value s7) {
    ...
    public static class Assign16Expr extends Assign8Expr {
        ...
        public Assign16Expr(CUDAOp8 opcode, CUDAKind kind, Value s0, Value s1, Value s2, Value s3, Value s4, Value s5, Value s6, Value s7, Value s8, Value s9, Value s10, Value s11, Value s12, Value s13,
                Value s14, Value s15) {
