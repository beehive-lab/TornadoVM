...
public class CUDAIntUnaryIntrinsicNode extends UnaryNode implements ArithmeticLIRLowerable, MarkIntIntrinsicNode {

    public static final NodeClass<CUDAIntUnaryIntrinsicNode> TYPE = NodeClass.create(CUDAIntUnaryIntrinsicNode.class);
    protected final Operation operation;
    protected CUDAIntUnaryIntrinsicNode(ValueNode x, Operation op, JavaKind kind) {
    ...
    public static ValueNode create(ValueNode x, Operation op, JavaKind kind) {
        ...
        return new CUDAIntUnaryIntrinsicNode(x, op, kind);
    }
