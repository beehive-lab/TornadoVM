...
public class CUDAAssemblerConstants {
    ...
    public static final String LOCAL_MEM_MODIFIER = "__shared__";
    public static final String PRIVATE_MEM_MODIFIER = "";
    public static final String CONSTANT_MEM_MODIFIER = "__constant__";
