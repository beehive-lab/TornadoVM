...
public class VectorElementSelectNode extends FloatingNode implements LIRLowerable {
    ...
    public VectorElementSelectNode(CUDAKind kind, ValueNode vector, ValueNode selection) {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        final CUDABinary.Selector expr = new CUDABinary.Selector(CUDABinaryOp.VECTOR_SELECT, gen.getLIRGeneratorTool().getLIRKind(stamp), targetVector, selectValue);
