...
public class LoadIndexedVectorNode extends LoadIndexedNode {
    ...
    private final CUDAKind oclKind;

    public LoadIndexedVectorNode(CUDAKind oclKind, ValueNode array, ValueNode index, JavaKind elementKind) {
        super(TYPE, CUDAStampFactory.getStampFor(oclKind), array, index, null, elementKind);
        this.oclKind = oclKind;
    }

    @Override
    public boolean inferStamp() {
        return updateStamp(CUDAStampFactory.getStampFor(oclKind));
    }
