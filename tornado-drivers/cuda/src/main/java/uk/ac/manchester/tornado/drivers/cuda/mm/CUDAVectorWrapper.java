...
public class CUDAVectorWrapper implements XPUBuffer {
    ...
    public CUDAVectorWrapper(final CUDADeviceContext device, final Object object, long batchSize, Access access) {
