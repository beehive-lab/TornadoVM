...
/**
 * A two-operand tile op spelled as a function rather than an operator, such as ct::max.
 */
@NodeInfo
public class CUDATileBinaryCallNode extends FixedWithNextNode implements LIRLowerable, CUDATileNode {

    public static final NodeClass<CUDATileBinaryCallNode> TYPE = NodeClass.create(CUDATileBinaryCallNode.class);
    ...
    public CUDATileBinaryCallNode(ValueNode left, ValueNode right, String function, DType dtype, int[] shape) {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        tool.append(new CUDATileStmt.TileBinaryCallStmt(result, gen.operand(left), gen.operand(right), function, dtype, shape));
