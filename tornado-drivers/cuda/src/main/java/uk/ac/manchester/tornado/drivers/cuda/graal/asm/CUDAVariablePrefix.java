...
/**
 * Enum representing the type-prefix mappings used for codegen of CUDADriver
 * variables.
 */
public enum CUDAVariablePrefix {
    // @formatter:off
    ULONG("ulong", "ul_"),
    UINT("uint", "ui_"),
    USHORT("ushort", "us_"),
    ...
    /**
     * It constructs an CUDAVariablePrefix enum with the specified type and prefix.
     *
     * @param type
     *     The type string.
     * @param prefix
     *     The prefix string.
     */
    CUDAVariablePrefix(String type, String prefix) {
        this.type = type;
        this.prefix = prefix;
    }
