...
public class CUDAFPBinaryIntrinsicNode extends BinaryNode implements ArithmeticLIRLowerable, MarkFloatingPointIntrinsicsNode {

    public static final NodeClass<CUDAFPBinaryIntrinsicNode> TYPE = NodeClass.create(CUDAFPBinaryIntrinsicNode.class);
    protected final Operation operation;
    protected CUDAFPBinaryIntrinsicNode(ValueNode x, ValueNode y, Operation op, JavaKind kind) {
    ...
    public static ValueNode create(ValueNode x, ValueNode y, Operation op, JavaKind kind) {
        ...
        return new CUDAFPBinaryIntrinsicNode(x, y, op, kind);
    }
