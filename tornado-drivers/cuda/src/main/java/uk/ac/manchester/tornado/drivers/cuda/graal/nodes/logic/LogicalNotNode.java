...
import static uk.ac.manchester.tornado.drivers.cuda.graal.asm.CUDAAssembler.CUDAUnaryOp.LOGICAL_NOT;
...
public class LogicalNotNode extends UnaryLogicalNode {
    ...
    public Value generate(LIRGeneratorTool tool, Value x) {
        ...
        AssignStmt assign = new AssignStmt(result, new CUDAUnary.Expr(LOGICAL_NOT, tool.getLIRKind(stamp), x));
        tool.append(assign);
        return result;
    }
