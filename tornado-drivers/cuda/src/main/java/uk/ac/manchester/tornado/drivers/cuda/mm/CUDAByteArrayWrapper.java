...
public class CUDAByteArrayWrapper extends CUDAArrayWrapper<byte[]> {
    ...
    public CUDAByteArrayWrapper(CUDADeviceContext device, long batchSize, Access access) {
        super(device, JavaKind.Byte, batchSize, access);
    }

    protected CUDAByteArrayWrapper(final byte[] array, final CUDADeviceContext device, long batchSize, Access access) {
    ...
    public int getSizeOfType() {
        return CUDAKind.BOOL.getSizeInBytes();
    }
