...
import static uk.ac.manchester.tornado.drivers.cuda.graal.asm.CUDAAssemblerConstants.FRAME_REF_NAME;
import static uk.ac.manchester.tornado.drivers.cuda.mm.CUDAKernelStackFrame.RETURN_VALUE_INDEX;

@Opcode("RETURN VALUE")
public class CUDAReturnSlot extends AllocatableValue {

    public CUDAReturnSlot(LIRKind lirKind) {
        super(lirKind);
    }

    public void emit(CUDACompilationResultBuilder crb, CUDAAssembler asm) {
        CUDAKind type = ((CUDAKind) getPlatformKind());
