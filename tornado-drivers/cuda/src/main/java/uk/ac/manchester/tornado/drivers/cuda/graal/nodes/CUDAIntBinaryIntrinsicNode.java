...
public class CUDAIntBinaryIntrinsicNode extends BinaryNode implements ArithmeticLIRLowerable, MarkIntIntrinsicNode {

    public static final NodeClass<CUDAIntBinaryIntrinsicNode> TYPE = NodeClass.create(CUDAIntBinaryIntrinsicNode.class);
    protected final Operation operation;
    protected CUDAIntBinaryIntrinsicNode(ValueNode x, ValueNode y, Operation op, JavaKind kind) {
    ...
    public static ValueNode create(ValueNode x, ValueNode y, Operation op, JavaKind kind) {
        ...
        return new CUDAIntBinaryIntrinsicNode(x, y, op, kind);
    }
