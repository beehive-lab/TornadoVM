...
public class TornadoAtomicIntegerNode extends FixedWithNextNode implements LIRLowerable {
    ...
    public TornadoAtomicIntegerNode(CUDAKind kind) {
    ...
    private void generateExpressionForOpenCL2_0(NodeLIRBuilderTool gen) {
        ...
        tool.append(new CUDALIRStmt.RelocatedExpressionStmt(new CUDAUnary.IntrinsicAtomicDeclaration(CUDAAssembler.CUDAUnaryIntrinsic.ATOMIC_VAR_INIT, result, gen.operand(initialValue))));
     ...
     *            {@link tornado.graal.compiler.nodes.ParameterNode}.
     */
