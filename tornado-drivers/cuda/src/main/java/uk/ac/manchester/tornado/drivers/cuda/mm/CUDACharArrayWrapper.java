...
public class CUDACharArrayWrapper extends CUDAArrayWrapper<char[]> {
    ...
    public CUDACharArrayWrapper(CUDADeviceContext device, long batchSize, Access access) {
        super(device, JavaKind.Char, batchSize, access);
    }

    protected CUDACharArrayWrapper(final char[] array, final CUDADeviceContext device, long batchSize, Access access) {
    ...
    public int getSizeOfType() {
        return CUDAKind.CHAR.getSizeInBytes();
    }
