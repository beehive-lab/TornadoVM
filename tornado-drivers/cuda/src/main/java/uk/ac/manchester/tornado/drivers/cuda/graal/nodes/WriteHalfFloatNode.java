...
public class WriteHalfFloatNode extends FixedWithNextNode implements LIRLowerable {
    ...
    public void generate(NodeLIRBuilderTool generator) {
        ...
        if (indexNode == null) {
            ...
            tool.append(new CUDALIRStmt.StoreStmt(cast, (CUDAUnary.MemoryAccess) addressValue, input));
        } else {
            Value index = generator.operand(indexNode);
            tool.append(new CUDALIRStmt.StoreStmt(cast, (CUDAUnary.MemoryAccess) addressValue, input, index));
        }
    }
}
