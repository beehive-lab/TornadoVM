...
import static uk.ac.manchester.tornado.drivers.cuda.graal.asm.CUDAAssembler.CUDABinaryOp.LOGICAL_OR;
...
public class LogicalOrNode extends BinaryLogicalNode {
    ...
    public Value generate(LIRGeneratorTool tool, Value x, Value y) {
        ...
        AssignStmt assign = new AssignStmt(result, new CUDABinary.Expr(LOGICAL_OR, tool.getLIRKind(stamp), x, y));
        tool.append(assign);
        return result;
    }
}
