...
public class AtomicAddNodeTemplate extends FixedWithNextNode implements LIRLowerable {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        tool.append(new CUDALIRStmt.AssignStmt(result, new CUDAUnary.Intrinsic(CUDAAssembler.CUDAUnaryIntrinsic.ATOMIC_ADD, tool.getLIRKind(stamp), gen.operand(inc))));
