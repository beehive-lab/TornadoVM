...
public class CUDALongArrayWrapper extends CUDAArrayWrapper<long[]> {
    ...
    public CUDALongArrayWrapper(CUDADeviceContext deviceContext, long batchSize, Access access) {
        super(deviceContext, JavaKind.Long, batchSize, access);
    }

    protected CUDALongArrayWrapper(final long[] array, final CUDADeviceContext device, long batchSize, Access access) {
    ...
    public int getSizeOfType() {
        return CUDAKind.LONG.getSizeInBytes();
    }
