...
public class CUDAIntArrayWrapper extends CUDAArrayWrapper<int[]> {
    ...
    public CUDAIntArrayWrapper(CUDADeviceContext device, long batchSize, Access access) {
        super(device, JavaKind.Int, batchSize, access);
    }

    protected CUDAIntArrayWrapper(int[] array, final CUDADeviceContext device, long batchSize, Access access) {
    ...
    public int getSizeOfType() {
        return CUDAKind.INT.getSizeInBytes();
    }
