...
@NodeInfo(shortName = "CUDA-FMA")
public class CUDAFMANode extends FloatingNode implements ArithmeticLIRLowerable, MarkFloatingPointIntrinsicsNode {

    public static final NodeClass<CUDAFMANode> TYPE = NodeClass.create(CUDAFMANode.class);
    ...
    public CUDAFMANode(ValueNode x, ValueNode y, ValueNode z) {
