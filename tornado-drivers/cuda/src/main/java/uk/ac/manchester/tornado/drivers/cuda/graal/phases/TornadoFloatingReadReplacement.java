...
public class TornadoFloatingReadReplacement extends PostRunCanonicalizationPhase<CoreProviders> {
    ...
    public static class FloatingReadClosure extends ReentrantNodeIterator.NodeIteratorClosure<TornadoFloatingReadReplacement.MemoryMapImpl> {
        ...
        /**
         * @param accessNode
         *     is a {@link FixedNode} that will be replaced by a {@link FloatingNode}. This method checks if the node that is going to be replaced has an {@link CUDABarrierNode} as next.
         */
        private static boolean isNextNodeCUDABarrierNode(FloatableAccessNode accessNode) {
            return (accessNode.next() instanceof CUDABarrierNode);
        }

        /**
         * @param nextNode
         *     is a {@link FixedNode} that will be replaced by a {@link FloatingNode}. This method removes the redundant {@link CUDABarrierNode}.
         */
        ...
        private void processFloatable(FloatableAccessNode accessNode, TornadoFloatingReadReplacement.MemoryMapImpl state) {
            ...
            if (accessNode.canFloat() && shouldBeFloatingRead(accessNode)) {
                ...
                try (DebugCloseable position = accessNode.withNodeSourcePosition()) {
                    ...
                    if (isNextNodeCUDABarrierNode(accessNode)) {
