...
public class VirtualCUDADevice implements CUDATargetDevice {
    ...
    private CUDADeviceContextInterface deviceContex;

    public VirtualCUDADevice(VirtualDeviceDescriptor info) {
