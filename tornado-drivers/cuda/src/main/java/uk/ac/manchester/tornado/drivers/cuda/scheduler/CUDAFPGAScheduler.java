...
public class CUDAFPGAScheduler extends CUDAKernelScheduler {

    public static final long[] DEFAULT_LOCAL_WORK_SIZE = { 64, 1, 1 };
    public static final String WARNING_FPGA_DEFAULT_LOCAL = "[TornadoVM CUDA] Warning: TornadoVM uses as default local work group size for FPGAs: " + Arrays.toString(DEFAULT_LOCAL_WORK_SIZE) + ".";
    private static final int WARP = 32;

    public CUDAFPGAScheduler(final CUDADeviceContext context) {
        super(context);
    }
