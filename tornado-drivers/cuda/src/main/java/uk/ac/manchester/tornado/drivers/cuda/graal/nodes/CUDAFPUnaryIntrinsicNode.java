...
public class CUDAFPUnaryIntrinsicNode extends UnaryNode implements ArithmeticLIRLowerable, MarkFloatingPointIntrinsicsNode {

    public static final NodeClass<CUDAFPUnaryIntrinsicNode> TYPE = NodeClass.create(CUDAFPUnaryIntrinsicNode.class);
    protected final Operation operation;

    protected CUDAFPUnaryIntrinsicNode(ValueNode value, Operation op, JavaKind kind) {
    ...
    public static ValueNode create(ValueNode value, Operation op, JavaKind kind) {
        ...
        return new CUDAFPUnaryIntrinsicNode(value, op, kind);
    }
