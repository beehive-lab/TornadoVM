...
import tornado.graal.compiler.replacements.SnippetTemplate.AbstractTemplates;
import tornado.graal.compiler.replacements.SnippetTemplate.Arguments;
...
/**
 * Tornado-Graal snippets for GPUs reductions using CUDADriver semantics.
 */
public class ReduceGPUSnippets implements Snippets {
    ...
    public static class Templates extends AbstractTemplates implements TornadoSnippetTypeInference {
        ...
        private SnippetInfo getSnippetFromCUDABinaryNodeLong(CUDAIntBinaryIntrinsicNode value, ValueNode extra) {
            switch (value.operation()) {
                case MAX:
        ...
        public SnippetInfo inferIntSnippet(ValueNode value, ValueNode extra) {
            ...
            } else if (value instanceof CUDAIntBinaryIntrinsicNode) {
                CUDAIntBinaryIntrinsicNode op = (CUDAIntBinaryIntrinsicNode) value;
                snippet = getSnippetFromCUDABinaryNodeInteger(op, extra);
            } else {
                throw new RuntimeException("Reduce Operation no supported yet: snippet not installed");
            }
            return snippet;
        ...
        public SnippetInfo inferLongSnippet(ValueNode value, ValueNode extra) {
            ...
            if (value instanceof TornadoReduceAddNode) {
                ...
                CUDAIntBinaryIntrinsicNode op = (CUDAIntBinaryIntrinsicNode) value;
                snippet = getSnippetFromCUDABinaryNodeLong(op, extra);
            } else {
                throw new RuntimeException("Reduce Operation no supported yet: snippet not installed");
            }
            return snippet;
        ...
        private SnippetInfo getSnippetFromCUDABinaryNodeInteger(CUDAFPBinaryIntrinsicNode value, ValueNode extra) {
            switch (value.operation()) {
                case FMAX:
                ...
                default:
                    throw new RuntimeException("CUDAFPBinaryIntrinsicNode operation not supported yet");
            }
        }
        ...
        public SnippetInfo inferFloatSnippet(ValueNode value, ValueNode extra) {
            ...
            } else if (value instanceof CUDAFPBinaryIntrinsicNode) {
                snippet = getSnippetFromCUDABinaryNodeInteger((CUDAFPBinaryIntrinsicNode) value, extra);
            } else {
                throw new RuntimeException("Reduce Operation no supported yet: snippet not installed");
            }
            return snippet;
        ...
        private SnippetInfo getSnippetFromCUDABinaryNodeDouble(CUDAFPBinaryIntrinsicNode value, ValueNode extra) {
            switch (value.operation()) {
                case FMAX:
        ...
        public SnippetInfo inferDoubleSnippet(ValueNode value, ValueNode extra) {
            ...
            if (value instanceof TornadoReduceAddNode) {
                ...
                snippet = getSnippetFromCUDABinaryNodeDouble((CUDAFPBinaryIntrinsicNode) value, extra);
            } else {
                throw new RuntimeException("Reduce Operation no supported yet: snippet not installed");
            }
            return snippet;
