...
import static uk.ac.manchester.tornado.drivers.cuda.graal.asm.CUDAAssembler.CUDABinaryOp.RELATIONAL_EQ;
...
public class LogicalEqualsNode extends BinaryLogicalNode {
    ...
    public Value generate(LIRGeneratorTool tool, Value x, Value y) {
        ...
        AssignStmt assign = new AssignStmt(result, new CUDABinary.Expr(RELATIONAL_EQ, tool.getLIRKind(stamp), x, y));
        tool.append(assign);
        return result;
    }
}
