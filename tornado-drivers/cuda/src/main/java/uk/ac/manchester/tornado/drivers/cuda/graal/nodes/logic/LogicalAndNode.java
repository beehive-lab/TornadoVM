...
import static uk.ac.manchester.tornado.drivers.cuda.graal.asm.CUDAAssembler.CUDABinaryOp.LOGICAL_AND;
...
public class LogicalAndNode extends BinaryLogicalNode {
    ...
    public Value generate(LIRGeneratorTool tool, Value x, Value y) {
        ...
        AssignStmt assign = new AssignStmt(result, new CUDABinary.Expr(LOGICAL_AND, tool.getLIRKind(stamp), x, y));
        tool.append(assign);
        return result;
    }
