...
import tornado.graal.compiler.nodes.spi.StampProvider;
...
public class CUDAProviders extends Providers {

    private final CUDASuitesProvider suites;

    public CUDAProviders(MetaAccessProvider metaAccess, //
            ...
            CUDASuitesProvider suitesProvider) {
