...
@NodeInfo
public class CUDAMMALoadBNode extends FixedWithNextNode implements LIRLowerable, MarkMMAFragment {

    public static final NodeClass<CUDAMMALoadBNode> TYPE = NodeClass.create(CUDAMMALoadBNode.class);

    @Input private ValueNode tile;
    @Input private ValueNode wmmaK;
    @OptionalInput private ValueNode byteOffset;

    public CUDAMMALoadBNode(ValueNode tile, ValueNode wmmaK) { this(tile, wmmaK, null); }
    public CUDAMMALoadBNode(ValueNode tile, ValueNode wmmaK, ValueNode byteOffset) {
