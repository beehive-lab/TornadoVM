...
import uk.ac.manchester.tornado.drivers.cuda.graal.phases.TornadoFixedArrayCopyPhase;
import uk.ac.manchester.tornado.drivers.cuda.graal.phases.TornadoHalfFloatVectorOffset;
import uk.ac.manchester.tornado.runtime.common.TornadoOptions;
import uk.ac.manchester.tornado.runtime.graal.compiler.TornadoLowTier;

public class CUDALowTier extends TornadoLowTier {
    ...
    public CUDALowTier(OptionValues options, TornadoDeviceContext tornadoDeviceContext, AddressLowering addressLowering) {
        ...
        appendPhase(new CUDAFP16SupportPhase(tornadoDeviceContext));
        ...
        appendPhase(new CUDAFieldCoopsAccessPhase());
