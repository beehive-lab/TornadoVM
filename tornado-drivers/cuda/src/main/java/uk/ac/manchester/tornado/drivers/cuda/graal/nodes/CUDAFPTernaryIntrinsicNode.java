...
import tornado.graal.compiler.nodes.calc.TernaryNode;
...
public class CUDAFPTernaryIntrinsicNode extends TernaryNode implements ArithmeticLIRLowerable, MarkFloatingPointIntrinsicsNode {

    public static final NodeClass<CUDAFPTernaryIntrinsicNode> TYPE = NodeClass.create(CUDAFPTernaryIntrinsicNode.class);
    protected final Operation operation;

    protected CUDAFPTernaryIntrinsicNode(ValueNode x, ValueNode y, ValueNode z, Operation op, JavaKind kind) {
    ...
    public static ValueNode create(ValueNode x, ValueNode y, ValueNode z, Operation op, JavaKind kind) {
        ...
        return new CUDAFPTernaryIntrinsicNode(x, y, z, op, kind);
    }
    ...
    public void generate(NodeLIRBuilderTool builder, ArithmeticLIRGeneratorTool lirGen) {
        CUDABuiltinTool gen = ((CUDAArithmeticTool) lirGen).getGen().getCUDABuiltinTool();
