...
public class CUDAIntrinsicNode {
    ...
    public static final class FixedBinaryGeometricOp extends FixedNode implements Floatable {
        ...
        public FixedBinaryGeometricOp(CUDAKind kind, GeometricOp op, ValueNode x, ValueNode y) {
            super(TYPE, CUDAStampFactory.getStampFor(kind.getElementKind()));
            this.operation = op;
            this.x = x;
            this.y = y;
        }
    ...
    public static class BinaryGeometricOp extends BinaryNode implements ArithmeticLIRLowerable {
        ...
        public void generate(NodeLIRBuilderTool builder, ArithmeticLIRGeneratorTool arithmeticTool) {
            CUDABuiltinTool gen = ((CUDAArithmeticTool) builder).getGen().getCUDABuiltinTool();
