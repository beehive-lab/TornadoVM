...
/**
 * A buffer for inspecting data within an CUDADriver device. It is not backed by any
 * userspace object.
 */
public class CUDAByteBuffer {
    ...
    public CUDAByteBuffer(CUDADeviceContext deviceContext, final long oclBufferId, final long offset, final long numBytes) {
