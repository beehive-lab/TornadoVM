...
public class CUDAIntTernaryIntrinsicNode extends TernaryNode implements ArithmeticLIRLowerable, MarkIntIntrinsicNode {

    public static final NodeClass<CUDAIntTernaryIntrinsicNode> TYPE = NodeClass.create(CUDAIntTernaryIntrinsicNode.class);
    protected final Operation operation;
    protected CUDAIntTernaryIntrinsicNode(ValueNode x, ValueNode y, ValueNode z, Operation op, JavaKind kind) {
    ...
    public static ValueNode create(ValueNode x, ValueNode y, ValueNode z, Operation op, JavaKind kind) {
        ...
        return new CUDAIntTernaryIntrinsicNode(x, y, z, op, kind);
    }
