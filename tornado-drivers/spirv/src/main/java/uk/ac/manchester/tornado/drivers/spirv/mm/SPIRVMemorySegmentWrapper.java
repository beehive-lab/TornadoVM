...
import uk.ac.manchester.tornado.api.types.vectors.VectorDouble2;
import uk.ac.manchester.tornado.api.types.vectors.VectorDouble3;
import uk.ac.manchester.tornado.api.types.vectors.VectorDouble4;
import uk.ac.manchester.tornado.api.types.vectors.VectorDouble8;
import uk.ac.manchester.tornado.api.types.vectors.VectorFloat2;
...
import uk.ac.manchester.tornado.api.types.vectors.VectorFloat8;
import uk.ac.manchester.tornado.api.types.vectors.VectorInt2;
import uk.ac.manchester.tornado.api.types.vectors.VectorInt3;
import uk.ac.manchester.tornado.api.types.vectors.VectorInt4;
import uk.ac.manchester.tornado.api.types.vectors.VectorInt8;
