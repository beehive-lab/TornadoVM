...
public class TestInts extends TestBase {
	...
	public void addInt2() {
		int size = 1;
		Int2 a = new Int2(new int[] {1, 2});
		Int2 b = new Int2(new int[] {3, 2});
	...
	public void addInt3() {
		int size = 1;
		Int3 a = new Int3(new int[] {1, 2, 3});
		Int3 b = new Int3(new int[] {3, 2, 1});
		VectorInt output = new VectorInt(size);
	...
	public void addInt4() {
		int size = 1;
		Int4 a = new Int4(new int[] {1, 2, 3, 4});
		Int4 b = new Int4(new int[] {4, 3, 2, 1});
		VectorInt output = new VectorInt(size);
