...
/**
 * Testing Tornado with one task in the same device.
 * The {@link TaskSchedule} contains a single task. This 
 * task is executed on either on the default device of the
 * one selected. 
 *
 */
