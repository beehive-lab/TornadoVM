...
public class TornadoOptions {
    ...
    /**
     * Dumps to stdout the OpenCL source code generated by the TornadoVM compiler.
     */
    public static final boolean OPENCL_PRINT_SOURCE = Boolean.parseBoolean(getProperty("tornado.opencl.source.print", "False"));
