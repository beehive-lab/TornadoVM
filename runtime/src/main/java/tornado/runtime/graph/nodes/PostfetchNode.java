...
public class PostfetchNode extends FixedDeviceOpNode {

    public PostfetchNode(TaskNode task) {
    ...
    public String toString() {
        return String.format("[%d]: postfetch parameter %d after task %d", id, value.getIndex(), task.getId());
    }
