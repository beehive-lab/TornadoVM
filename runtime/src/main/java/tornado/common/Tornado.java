...
public final class Tornado {
    ...
    public static final boolean ENABLE_EXCEPTIONS = Boolean.parseBoolean(settings.getProperty("tornado.exceptions", "False"));
    /*
    ...
    public static final int EVENT_WINDOW = Integer.parseInt(getProperty("tornado.opencl.eventwindow", "64"));
