...
public class ComputeKernels {
     ...
     * 
     * @param randArray array of random values of current option price @param
     * sigma Array of random values sigma @param k Array of random values strike
     * price
     * 
     * @param put array of random values of expiration time @param r Array of
     ...
     * 
     * @param call array of calculated put price values
     */
