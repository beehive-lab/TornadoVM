...
public class NBodyTornado {
    ...
    private static void nbodytornado(int numBodies, float[] refPos, float[] refVel, float delT, float espSqr) {
    ...
    public static void main(String[] args) {
        ...
        final TaskSchedule t0 = new TaskSchedule("s0").task("t0", NBodyTornado::nbodytornado, numBodies, posSeq, velSeq, delT, espSqr);
