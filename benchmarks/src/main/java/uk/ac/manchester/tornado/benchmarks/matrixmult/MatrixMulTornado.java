...
package uk.ac.manchester.tornado.benchmarks.matrixmult;
...
public class MatrixMulTornado extends BenchmarkDriver {
    private int numElements;
    private float[] a,b,c;
    private TaskSchedule graph;

    public MatrixMulTornado(int iterations, int numElements) {
        super(iterations);
