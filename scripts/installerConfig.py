...
MAVEN = {
    __LINUX__ : {
        __X86_64__ : "https://dlcdn.apache.org/maven/maven-3/3.9.4/binaries/apache-maven-3.9.4-bin.tar.gz",
        __ARM__    : "https://dlcdn.apache.org/maven/maven-3/3.9.4/binaries/apache-maven-3.9.4-bin.tar.gz",
    },
    __APPLE__ : {
        __X86_64__ : None,   
        __ARM__    : None,
