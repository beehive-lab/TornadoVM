...
public class TestInitDataTypes extends TornadoTestBase {
    ...
    @Test
    public void testInitFloatArray() {
    ...
    @Test
    public void testInitDoubleArray() {
    ...
    @Test
    public void testInitShortArray() {
    ...
    @Test
    public void testInitHalfFloatArray() {
