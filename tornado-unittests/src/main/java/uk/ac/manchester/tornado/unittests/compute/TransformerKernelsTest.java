...
public class TransformerKernelsTest extends TornadoTestBase {
     ...
     */
    private void copyToCacheSequential(FloatArray destKeyCache, FloatArray srcKey, FloatArray destValueCache,
            FloatArray srcValue, IntArray positionNlayer, int kvDim, int layer, int contextLength) {
     ...
     */
    private void processHeadsSequential(FloatArray q, FloatArray key_cache, FloatArray value_cache, FloatArray xb,
            int nHeads, int headSize, int kvDim, int kvMul, int seqLen, IntArray positionNlayer,
    ...
    public void testReductionOneBlockWithLayer() throws TornadoExecutionPlanException {
        ...
        TaskGraph taskGraph = new TaskGraph("s0")
                ...
                .task("t0", TransformerKernelsTest::reductionOneBlockWithLayer, new KernelContext(),
                        output, input, size, ermsNorm, localSize)
    ...
    public void testReductionOneBlock2WithLayer() throws TornadoExecutionPlanException {
        ...
        TaskGraph taskGraph = new TaskGraph("s0")
                .transferToDevice(DataTransferMode.FIRST_EXECUTION, input, weights, temp)
                .task("t0", TransformerKernelsTest::reductionOneBlock2WithLayer, new KernelContext(),
                        output, input, weights, temp)
                .transferToHost(DataTransferMode.EVERY_EXECUTION, output);
    ...
    public void testCopyToCache() throws TornadoExecutionPlanException {
        ...
        // Set up TornadoVM execution
        TaskGraph taskGraph = new TaskGraph("s0")
                .transferToDevice(DataTransferMode.FIRST_EXECUTION, srcKey, srcValue, positionNlayer)
                .task("t0", TransformerKernelsTest::copyToCache,
                        destKeyCache, srcKey, destValueCache, srcValue, positionNlayer, kvDim, layer, contextLength)
                .transferToHost(DataTransferMode.EVERY_EXECUTION, destKeyCache, destValueCache);
    ...
    public void testRopeRotation() throws TornadoExecutionPlanException {
        ...
        TaskGraph taskGraph = new TaskGraph("s0")
                .transferToDevice(DataTransferMode.FIRST_EXECUTION, sq, sk, positionHolder)
                .task("t0", TransformerKernelsTest::ropeRotation, new KernelContext(),
                        positionHolder, sq, sk, kvDim, headSize)
    ...
    public void testProcessHeadsParallel() throws TornadoExecutionPlanException {
        ...
        // Run sequential version
        processHeadsSequential(query, keyCache, valueCache, outputSeq, nHeads, headSize, kvDim, kvMul,
                seqLen, positionHolder, attentionWeightsSeq, layer, contextLength);
        ...
        TaskGraph taskGraph = new TaskGraph("s0")
                .transferToDevice(DataTransferMode.FIRST_EXECUTION, query, keyCache, valueCache, positionHolder)
                .task("t0", TransformerKernelsTest::processHeadsParallel,
                        query, keyCache, valueCache, output, nHeads, headSize, kvDim, kvMul, seqLen,
                        positionHolder, attentionWeights, layer, contextLength)
    ...
    public void testMatrixVectorGeneric() throws TornadoExecutionPlanException {
        ...
        TaskGraph taskGraph = new TaskGraph("s0")
                ...
                .task("t0", TransformerKernelsTest::matrixVectorGeneric, new KernelContext(),
                        input, output, weights, inputDim, outputDim, localWorkGroupSize)
                .transferToHost(DataTransferMode.EVERY_EXECUTION, output);
    ...
    public void testMatrixVectorGenericWithResidual() throws TornadoExecutionPlanException {
        ...
        TaskGraph taskGraph = new TaskGraph("s0")
                .transferToDevice(DataTransferMode.FIRST_EXECUTION, input, weights, output)
                .task("t0", TransformerKernelsTest::matrixVectorGenericWithResidual, new KernelContext(),
                        input, output, weights, inputDim, outputDim, localWorkGroupSize)
                .transferToHost(DataTransferMode.EVERY_EXECUTION, output);
    ...
    public void testFusedFeedForwardWithSiLUAndGLUActivation() throws TornadoExecutionPlanException {
        ...
        TaskGraph taskGraph = new TaskGraph("s0")
                .transferToDevice(DataTransferMode.FIRST_EXECUTION, input, w1, w3)
                .task("t0", TransformerKernelsTest::fusedFeedForwardWithSiLUAndGLUActivation, new KernelContext(),
                        input, output, w1, w3, inputDim, hiddenDim, localWorkGroupSize)
                .transferToHost(DataTransferMode.EVERY_EXECUTION, output);
