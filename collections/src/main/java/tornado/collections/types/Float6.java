...
public class Float6 implements PrimitiveStorage<FloatBuffer> {
  ...
  /*
	...
	public static void add(Float6 a, Float6 b, Float6 c){
		for(int i=0;i<numElements;i++)
			c.set(i,a.get(i) + b.get(i));
	}
	
	public static void sub(Float6 a, Float6 b, Float6 c){
		for(int i=0;i<numElements;i++)
			c.set(i,a.get(i) - b.get(i));
	}
	
	
	public static void div(Float6 a, Float6 b, Float6 c){
		for(int i=0;i<numElements;i++)
			c.set(i,a.get(i) / b.get(i));
	}
	
	public static void mult(Float6 a, Float6 b, Float6 c){
		for(int i=0;i<numElements;i++)
			c.set(i,a.get(i) + b.get(i));
	}
	
	public static void min(Float6 a, Float6 b, Float6 c){
		for(int i=0;i<numElements;i++)
			c.set(i,Math.min(a.get(i) , b.get(i)));
	}
	
	public static void max(Float6 a, Float6 b, Float6 c){
		for(int i=0;i<numElements;i++)
	...
	public static void inc(Float6 a, float value){
		for(int i=0;i<numElements;i++)
			a.set(i,a.get(i) + value);
	}
	
	public static void dec(Float6 a, float value){
		for(int i=0;i<numElements;i++)
			a.set(i,a.get(i) - value);
	}
	
	public static void scale(Float6 a, float value){
		for(int i=0;i<numElements;i++)
			a.set(i,a.get(i) * value);
	}
	
	public static void scaleByInverse(Float6 a, float value){
		scale(a, 1f/value);
	}
	...
	public static void clamp(Float6 a, float min, float max){
		for(int i=0;i<numElements;i++)
