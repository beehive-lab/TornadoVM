    ...
    protected void run(StructuredGraph graph, TornadoHighTierContext context) {
        ...
        while (hasWork) {
            ...
            if (context.hasArgs()) {
                ...
                Debug.dump(Debug.INFO_LOG_LEVEL, graph, "After Phase Propagate Parameters");
            } else {
                for (final ParameterNode param : graph.getNodes(ParameterNode.TYPE)) {
                    assumeNonNull(graph, param);
                }
                Debug.dump(Debug.INFO_LOG_LEVEL, graph, "After Phase assume non null Parameters");
            }
...
//                                    graph.removeFloating(pi);
            ...
            Debug.dump(Debug.INFO_LOG_LEVEL, graph, "After Phase Pi Node Removal");
