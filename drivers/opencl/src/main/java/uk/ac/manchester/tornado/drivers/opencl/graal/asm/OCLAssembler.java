...
public final class OCLAssembler extends Assembler {
    ...
    public static class OCLBinaryTemplate extends OCLBinaryOp {
        ...
        public static final OCLBinaryTemplate NEW_LOCAL_INT_ARRAY2 = new OCLBinaryTemplate("local memory array", "ulong %s = (__local ulong) &_local_region[0]; //__local int %s ");
        ...
        public static final OCLBinaryTemplate NEW_LOCAL_BYTE = new OCLBinaryTemplate("local memory array float", "__local byte %s[%s]");
        // @formatter:on
        private final String template;
