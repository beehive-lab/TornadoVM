 ...
 *
 */
package uk.ac.manchester.tornado.drivers.opencl.common;
...
public class OCLLogger {
    ...
    /**
     * Method to track OpenCL code generation
     *
     * @param message
    ...
    public static void traceCodeGen(final String message, final Object... args) {
        if (TornadoOptions.TRACE_CODE_GEN) {
            System.out.printf(Colour.CYAN + "[OCL-CodeGen] " + message + Colour.RESET + "\n", args);
        }
    }

    /**
     * Method to track OpenCL IR Builder (from last IR phase to IR Builder for
     * codegen)
     *
     * @param message
    ...
    public static void traceBuildLIR(String message, final Object... args) {
        if (TornadoOptions.TRACE_BUILD_LIR) {
            System.out.printf(Colour.GREEN + "[OCL-BuildLIR] " + message + Colour.RESET + "\n", args);
        }
    }
    ...
    public static void traceRuntime(String message, final Object... args) {
        System.out.printf(Colour.YELLOW + "[OCL-Runtime] " + message + Colour.RESET + "\n", args);
    }
