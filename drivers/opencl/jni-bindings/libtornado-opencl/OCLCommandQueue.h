...
#include <jni.h>
/* Header for class tornado_drivers_opencl_OCLCommandQueue */

#ifndef _Included_tornado_drivers_opencl_OCLCommandQueue
#define _Included_tornado_drivers_opencl_OCLCommandQueue
#ifdef __cplusplus
extern "C" {
#endif
    /*
     ...
     */
    JNIEXPORT jlong JNICALL Java_tornado_drivers_opencl_OCLCommandQueue_clEnqueueMapBuffer
    (JNIEnv *, jclass, jlong, jlong, jlong, jboolean, jint, jlong, jlong, jlongArray);

    /*
     * Class:     tornado_drivers_opencl_OCLCommandQueue
     * Method:    clEnqueueMapBuffer2
     * Signature: (JJZIJJ[J)Ltornado/drivers/opencl/OCLCommandQueue/OCLMapResult;
     */
    JNIEXPORT jobject JNICALL Java_tornado_drivers_opencl_OCLCommandQueue_clEnqueueMapBuffer2
     ...
     */
    JNIEXPORT jlong JNICALL Java_tornado_drivers_opencl_OCLCommandQueue_clEnqueueUnmapMemObject
...
#endif
#endif
/* Header for class tornado_drivers_opencl_OCLCommandQueue_OCLMapResult */

#ifndef _Included_tornado_drivers_opencl_OCLCommandQueue_OCLMapResult
#define _Included_tornado_drivers_opencl_OCLCommandQueue_OCLMapResult
#ifdef __cplusplus
extern "C" {
#endif
#ifdef __cplusplus
