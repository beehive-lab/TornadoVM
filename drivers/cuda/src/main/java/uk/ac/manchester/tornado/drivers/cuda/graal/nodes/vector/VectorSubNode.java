...
public class VectorSubNode extends FloatingNode implements LIRLowerable, VectorOp {
    ...
    protected VectorSubNode(NodeClass<? extends VectorSubNode> c, PTXKind kind, ValueNode x, ValueNode y) {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        gen.getLIRGeneratorTool().append(new PTXLIRStmt.AssignStmt(result, new PTXBinary.Expr(PTXAssembler.PTXBinaryOp.SUB, gen.getLIRGeneratorTool().getLIRKind(stamp), input1, input2)));
