...
public class TestPTXTornadoCompiler {
    ...
    public static void main(String[] args) {
        ...
        CUDAPlatform platform = CUDA.getPlatform();
        CUDACodeCache codeCache = platform.getDevice(0).getContext().getDeviceContext().getCodeCache();

        TornadoCoreRuntime tornadoRuntime = TornadoCoreRuntime.getTornadoRuntime();
        PTXBackend backend = tornadoRuntime.getDriver(CUDADriver.class).getDefaultBackend();
