...
public class VectorDivNode extends FloatingNode implements LIRLowerable, VectorOp {
    ...
    protected VectorDivNode(NodeClass<? extends VectorDivNode> c, PTXKind kind, ValueNode x, ValueNode y) {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        gen.getLIRGeneratorTool().append(new PTXLIRStmt.AssignStmt(result, new PTXBinary.Expr(PTXAssembler.PTXBinaryOp.DIV, gen.getLIRGeneratorTool().getLIRKind(stamp), input1, input2)));
