...
public class VectorMulNode extends FloatingNode implements LIRLowerable, VectorOp {
    ...
    protected VectorMulNode(NodeClass<? extends VectorMulNode> c, PTXKind kind, ValueNode x, ValueNode y) {
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        gen.getLIRGeneratorTool().append(new PTXLIRStmt.AssignStmt(result, new PTXBinary.Expr(PTXAssembler.PTXBinaryOp.MUL, gen.getLIRGeneratorTool().getLIRKind(stamp), input1, input2)));
