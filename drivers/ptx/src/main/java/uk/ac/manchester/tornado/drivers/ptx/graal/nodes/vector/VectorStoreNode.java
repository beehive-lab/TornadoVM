...
public final class VectorStoreNode extends AccessIndexedNode {
    ...
    public VectorStoreNode(PTXKind vectorKind, ValueNode array, ValueNode index, ValueNode value) {
        super(TYPE, PTXStampFactory.getStampFor(vectorKind), array, index, null, JavaKind.Illegal);
        this.value = value;
    }
