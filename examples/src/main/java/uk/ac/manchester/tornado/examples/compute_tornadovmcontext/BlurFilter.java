...
public class BlurFilter {
    ...
    public static class BlurFilterImage extends Component {
        ...
        private static void compute(TornadoVMContext context, int[] channel, int[] channelBlurred, final int numRows, final int numCols, float[] filter, final int filterWidth) {
            // For every pixel in the image
            assert (filterWidth % 2 == 1);
            // int r = context.threadIdx;
            // int c = context.threadIdy;
        ...
        private void parallelCompute() {
            ...
            parallelFilter.execute(gridTask);
