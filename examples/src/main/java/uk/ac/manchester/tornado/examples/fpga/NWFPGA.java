...
public class NWFPGA {
    ...
    private static void traceback(int max_rows, int max_cols, int penalty, int[] input_itemsets, int[] referrence) {
        try (PrintStream out = new PrintStream(new FileOutputStream("result.txt"));) {
            ...
            Logger.getLogger(NWFPGA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        TaskSchedule s0 = new TaskSchedule("s0").task("init-ref", NWFPGA::initialiseReference, max_rows, max_cols, input_itemsets, referrence, blosum62)
                .task("init-input1", NWFPGA::initialiseInput, max_rows, max_cols, penalty, input_itemsets).task("init-input2", NWFPGA::initialiseInput, max_cols, 1, penalty, input_itemsets)
                .task("topleft", NWFPGA::processTopLeft, max_rows, max_cols, penalty, input_itemsets, referrence)
                .task("bottomright", NWFPGA::processBottomRight, max_rows, max_cols, penalty, input_itemsets, referrence).streamOut(input_itemsets, referrence);
