...
public class BufetBigIndex {
    ...
    public static int[] getRandomTargetGroup(int upperBound, int size, byte[] onlyGeneVector) {
        ...
        Random rand = new Random();                                                                 //mt19937 on C++ code
        //Compact miRNA bit representation in 32-bits numbers (MSB 16-bits getting wasted)
    ...
    public static long[] findIntersections(int size, int[] map_all, short[] countOnes,
