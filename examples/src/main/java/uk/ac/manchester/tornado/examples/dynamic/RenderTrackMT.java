...
public class RenderTrackMT {
    ...
    public static void renderTrackThreads(ImageByte3 output, ImageFloat3 input, int threads, Thread[] th) throws InterruptedException {
        ...
        for (int i = 0; i < iterations; i++) {
            switch (executionType) {
                ...
                case "multi":
                    System.gc();
                    start = System.nanoTime();
                    renderTrackThreads(output, input, maxSystemThreads, threads);
                    end = System.nanoTime();
                    break;
                default:
                    start = System.nanoTime();
