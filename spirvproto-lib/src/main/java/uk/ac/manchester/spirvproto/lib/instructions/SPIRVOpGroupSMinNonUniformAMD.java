...
public class SPIRVOpGroupSMinNonUniformAMD extends SPIRVInstruction {
    ...
    public SPIRVOpGroupSMinNonUniformAMD(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVGroupOperation _operation, SPIRVId _x) {
        super(5004, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _operation.getWordCount() + _x.getWordCount() + 1, "OpGroupSMinNonUniformAMD", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupSMinNonUniformAMD) {
            SPIRVOpGroupSMinNonUniformAMD otherInst = (SPIRVOpGroupSMinNonUniformAMD) other;
