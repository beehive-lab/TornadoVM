...
public class SPIRVOpImageSampleDrefImplicitLod extends SPIRVInstruction {
    ...
    public SPIRVOpImageSampleDrefImplicitLod(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _sampledImage, SPIRVId _coordinate, SPIRVId _dRef, SPIRVOptionalOperand<SPIRVImageOperands> _imageOperands) {
        super(89, _idResultType.getWordCount() + _idResult.getWordCount() + _sampledImage.getWordCount() + _coordinate.getWordCount() + _dRef.getWordCount() + _imageOperands.getWordCount() + 1, "OpImageSampleDrefImplicitLod", SPIRVCapability.Shader());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpImageSampleDrefImplicitLod) {
            SPIRVOpImageSampleDrefImplicitLod otherInst = (SPIRVOpImageSampleDrefImplicitLod) other;
