...
public class SPIRVOpAtomicIDecrement extends SPIRVInstruction {
    ...
    public SPIRVOpAtomicIDecrement(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _pointer, SPIRVId _scope, SPIRVId _semantics) {
        super(233, _idResultType.getWordCount() + _idResult.getWordCount() + _pointer.getWordCount() + _scope.getWordCount() + _semantics.getWordCount() + 1, "OpAtomicIDecrement");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpAtomicIDecrement) {
            SPIRVOpAtomicIDecrement otherInst = (SPIRVOpAtomicIDecrement) other;
