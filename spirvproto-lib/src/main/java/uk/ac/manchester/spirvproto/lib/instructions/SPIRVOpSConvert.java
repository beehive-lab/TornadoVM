...
public class SPIRVOpSConvert extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _signedValue;

    public SPIRVOpSConvert(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _signedValue) {
        super(114, _idResultType.getWordCount() + _idResult.getWordCount() + _signedValue.getWordCount() + 1, "OpSConvert");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpSConvert) {
            SPIRVOpSConvert otherInst = (SPIRVOpSConvert) other;
