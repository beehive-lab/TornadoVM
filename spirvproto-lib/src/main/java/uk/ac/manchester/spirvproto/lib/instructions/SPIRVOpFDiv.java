...
public class SPIRVOpFDiv extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _operand1;
    public final SPIRVId _operand2;

    public SPIRVOpFDiv(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _operand1, SPIRVId _operand2) {
        super(136, _idResultType.getWordCount() + _idResult.getWordCount() + _operand1.getWordCount() + _operand2.getWordCount() + 1, "OpFDiv");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpFDiv) {
            SPIRVOpFDiv otherInst = (SPIRVOpFDiv) other;
