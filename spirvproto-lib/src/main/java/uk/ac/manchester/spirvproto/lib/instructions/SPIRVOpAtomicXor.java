...
public class SPIRVOpAtomicXor extends SPIRVInstruction {
    ...
    public SPIRVOpAtomicXor(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _pointer, SPIRVId _scope, SPIRVId _semantics, SPIRVId _value) {
        super(242, _idResultType.getWordCount() + _idResult.getWordCount() + _pointer.getWordCount() + _scope.getWordCount() + _semantics.getWordCount() + _value.getWordCount() + 1, "OpAtomicXor");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpAtomicXor) {
            SPIRVOpAtomicXor otherInst = (SPIRVOpAtomicXor) other;
