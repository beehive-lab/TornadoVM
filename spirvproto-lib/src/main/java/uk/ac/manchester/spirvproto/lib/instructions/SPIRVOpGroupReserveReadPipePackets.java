...
public class SPIRVOpGroupReserveReadPipePackets extends SPIRVInstruction {
    ...
    public SPIRVOpGroupReserveReadPipePackets(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVId _pipe, SPIRVId _numPackets, SPIRVId _packetSize, SPIRVId _packetAlignment) {
        super(285, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _pipe.getWordCount() + _numPackets.getWordCount() + _packetSize.getWordCount() + _packetAlignment.getWordCount() + 1, "OpGroupReserveReadPipePackets", SPIRVCapability.Pipes());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupReserveReadPipePackets) {
            SPIRVOpGroupReserveReadPipePackets otherInst = (SPIRVOpGroupReserveReadPipePackets) other;
