...
public class SPIRVOpShiftRightArithmetic extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _base;
    public final SPIRVId _shift;

    public SPIRVOpShiftRightArithmetic(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _base, SPIRVId _shift) {
        super(195, _idResultType.getWordCount() + _idResult.getWordCount() + _base.getWordCount() + _shift.getWordCount() + 1, "OpShiftRightArithmetic");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpShiftRightArithmetic) {
            SPIRVOpShiftRightArithmetic otherInst = (SPIRVOpShiftRightArithmetic) other;
