...
public class SPIRVOpReserveWritePipePackets extends SPIRVInstruction {
    ...
    public SPIRVOpReserveWritePipePackets(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _pipe, SPIRVId _numPackets, SPIRVId _packetSize, SPIRVId _packetAlignment) {
        super(279, _idResultType.getWordCount() + _idResult.getWordCount() + _pipe.getWordCount() + _numPackets.getWordCount() + _packetSize.getWordCount() + _packetAlignment.getWordCount() + 1, "OpReserveWritePipePackets", SPIRVCapability.Pipes());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpReserveWritePipePackets) {
            SPIRVOpReserveWritePipePackets otherInst = (SPIRVOpReserveWritePipePackets) other;
