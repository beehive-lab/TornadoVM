...
public class SPIRVOpDPdx extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _p;

    public SPIRVOpDPdx(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _p) {
        super(207, _idResultType.getWordCount() + _idResult.getWordCount() + _p.getWordCount() + 1, "OpDPdx", SPIRVCapability.Shader());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpDPdx) {
            SPIRVOpDPdx otherInst = (SPIRVOpDPdx) other;
