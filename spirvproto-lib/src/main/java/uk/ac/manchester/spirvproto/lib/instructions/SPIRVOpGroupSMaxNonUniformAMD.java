...
public class SPIRVOpGroupSMaxNonUniformAMD extends SPIRVInstruction {
    ...
    public SPIRVOpGroupSMaxNonUniformAMD(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVGroupOperation _operation, SPIRVId _x) {
        super(5007, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _operation.getWordCount() + _x.getWordCount() + 1, "OpGroupSMaxNonUniformAMD", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupSMaxNonUniformAMD) {
            SPIRVOpGroupSMaxNonUniformAMD otherInst = (SPIRVOpGroupSMaxNonUniformAMD) other;
