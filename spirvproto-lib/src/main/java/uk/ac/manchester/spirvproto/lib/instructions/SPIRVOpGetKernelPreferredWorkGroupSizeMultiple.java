...
public class SPIRVOpGetKernelPreferredWorkGroupSizeMultiple extends SPIRVInstruction {
    ...
    public SPIRVOpGetKernelPreferredWorkGroupSizeMultiple(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _invoke, SPIRVId _param, SPIRVId _paramSize, SPIRVId _paramAlign) {
        super(296, _idResultType.getWordCount() + _idResult.getWordCount() + _invoke.getWordCount() + _param.getWordCount() + _paramSize.getWordCount() + _paramAlign.getWordCount() + 1, "OpGetKernelPreferredWorkGroupSizeMultiple", SPIRVCapability.DeviceEnqueue());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGetKernelPreferredWorkGroupSizeMultiple) {
            SPIRVOpGetKernelPreferredWorkGroupSizeMultiple otherInst = (SPIRVOpGetKernelPreferredWorkGroupSizeMultiple) other;
