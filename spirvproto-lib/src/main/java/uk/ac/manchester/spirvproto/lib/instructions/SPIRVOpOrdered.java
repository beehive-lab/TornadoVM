...
public class SPIRVOpOrdered extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _x;
    public final SPIRVId _y;

    public SPIRVOpOrdered(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _x, SPIRVId _y) {
        super(162, _idResultType.getWordCount() + _idResult.getWordCount() + _x.getWordCount() + _y.getWordCount() + 1, "OpOrdered", SPIRVCapability.Kernel());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpOrdered) {
            SPIRVOpOrdered otherInst = (SPIRVOpOrdered) other;
