...
public class SPIRVOpGroupUMin extends SPIRVInstruction {
    ...
    public SPIRVOpGroupUMin(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVGroupOperation _operation, SPIRVId _x) {
        super(267, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _operation.getWordCount() + _x.getWordCount() + 1, "OpGroupUMin", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupUMin) {
            SPIRVOpGroupUMin otherInst = (SPIRVOpGroupUMin) other;
