...
public class SPIRVOpGroupFMax extends SPIRVInstruction {
    ...
    public SPIRVOpGroupFMax(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVGroupOperation _operation, SPIRVId _x) {
        super(269, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _operation.getWordCount() + _x.getWordCount() + 1, "OpGroupFMax", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupFMax) {
            SPIRVOpGroupFMax otherInst = (SPIRVOpGroupFMax) other;
