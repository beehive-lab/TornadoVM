...
public class SPIRVOpImageSampleProjDrefExplicitLod extends SPIRVInstruction {
    ...
    public SPIRVOpImageSampleProjDrefExplicitLod(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _sampledImage, SPIRVId _coordinate, SPIRVId _dRef, SPIRVImageOperands _imageOperands) {
        super(94, _idResultType.getWordCount() + _idResult.getWordCount() + _sampledImage.getWordCount() + _coordinate.getWordCount() + _dRef.getWordCount() + _imageOperands.getWordCount() + 1, "OpImageSampleProjDrefExplicitLod", SPIRVCapability.Shader());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpImageSampleProjDrefExplicitLod) {
            SPIRVOpImageSampleProjDrefExplicitLod otherInst = (SPIRVOpImageSampleProjDrefExplicitLod) other;
