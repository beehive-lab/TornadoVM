...
public class SPIRVOpLifetimeStart extends SPIRVInstruction {
    public final SPIRVId _pointer;
    public final SPIRVLiteralInteger _size;

    public SPIRVOpLifetimeStart(SPIRVId _pointer, SPIRVLiteralInteger _size) {
        super(256, _pointer.getWordCount() + _size.getWordCount() + 1, "OpLifetimeStart", SPIRVCapability.Kernel());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpLifetimeStart) {
            SPIRVOpLifetimeStart otherInst = (SPIRVOpLifetimeStart) other;
