...
public class SPIRVOpGetKernelNDrangeSubGroupCount extends SPIRVInstruction {
    ...
    public SPIRVOpGetKernelNDrangeSubGroupCount(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _nDRange, SPIRVId _invoke, SPIRVId _param, SPIRVId _paramSize, SPIRVId _paramAlign) {
        super(293, _idResultType.getWordCount() + _idResult.getWordCount() + _nDRange.getWordCount() + _invoke.getWordCount() + _param.getWordCount() + _paramSize.getWordCount() + _paramAlign.getWordCount() + 1, "OpGetKernelNDrangeSubGroupCount", SPIRVCapability.DeviceEnqueue());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGetKernelNDrangeSubGroupCount) {
            SPIRVOpGetKernelNDrangeSubGroupCount otherInst = (SPIRVOpGetKernelNDrangeSubGroupCount) other;
