...
public class SPIRVPairLiteralIntegerIdRef implements SPIRVOperand {
    private final SPIRVLiteralInteger member1;
    private final SPIRVId member2;

    public final SPIRVCapability[] capabilities;

    public SPIRVPairLiteralIntegerIdRef(SPIRVLiteralInteger member1, SPIRVId member2) {
