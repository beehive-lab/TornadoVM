...
public class SPIRVOpLogicalNotEqual extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _operand1;
    public final SPIRVId _operand2;

    public SPIRVOpLogicalNotEqual(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _operand1, SPIRVId _operand2) {
        super(165, _idResultType.getWordCount() + _idResult.getWordCount() + _operand1.getWordCount() + _operand2.getWordCount() + 1, "OpLogicalNotEqual");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpLogicalNotEqual) {
            SPIRVOpLogicalNotEqual otherInst = (SPIRVOpLogicalNotEqual) other;
