...
public class SPIRVOpAtomicUMin extends SPIRVInstruction {
    ...
    public SPIRVOpAtomicUMin(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _pointer, SPIRVId _scope, SPIRVId _semantics, SPIRVId _value) {
        super(237, _idResultType.getWordCount() + _idResult.getWordCount() + _pointer.getWordCount() + _scope.getWordCount() + _semantics.getWordCount() + _value.getWordCount() + 1, "OpAtomicUMin");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpAtomicUMin) {
            SPIRVOpAtomicUMin otherInst = (SPIRVOpAtomicUMin) other;
