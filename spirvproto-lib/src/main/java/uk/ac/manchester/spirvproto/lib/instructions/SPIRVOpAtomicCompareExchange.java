...
public class SPIRVOpAtomicCompareExchange extends SPIRVInstruction {
    ...
    public SPIRVOpAtomicCompareExchange(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _pointer, SPIRVId _scope, SPIRVId _equal, SPIRVId _unequal, SPIRVId _value, SPIRVId _comparator) {
        super(230, _idResultType.getWordCount() + _idResult.getWordCount() + _pointer.getWordCount() + _scope.getWordCount() + _equal.getWordCount() + _unequal.getWordCount() + _value.getWordCount() + _comparator.getWordCount() + 1, "OpAtomicCompareExchange");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpAtomicCompareExchange) {
            SPIRVOpAtomicCompareExchange otherInst = (SPIRVOpAtomicCompareExchange) other;
