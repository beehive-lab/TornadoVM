...
public class SPIRVOpInBoundsPtrAccessChain extends SPIRVInstruction {
    ...
    public SPIRVOpInBoundsPtrAccessChain(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _base, SPIRVId _element, SPIRVMultipleOperands<SPIRVId> _indexes) {
        super(70, _idResultType.getWordCount() + _idResult.getWordCount() + _base.getWordCount() + _element.getWordCount() + _indexes.getWordCount() + 1, "OpInBoundsPtrAccessChain", SPIRVCapability.Addresses());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpInBoundsPtrAccessChain) {
            SPIRVOpInBoundsPtrAccessChain otherInst = (SPIRVOpInBoundsPtrAccessChain) other;
