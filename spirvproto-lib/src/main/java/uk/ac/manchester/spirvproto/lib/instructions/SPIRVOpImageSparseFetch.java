...
public class SPIRVOpImageSparseFetch extends SPIRVInstruction {
    ...
    public SPIRVOpImageSparseFetch(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _image, SPIRVId _coordinate, SPIRVOptionalOperand<SPIRVImageOperands> _imageOperands) {
        super(313, _idResultType.getWordCount() + _idResult.getWordCount() + _image.getWordCount() + _coordinate.getWordCount() + _imageOperands.getWordCount() + 1, "OpImageSparseFetch", SPIRVCapability.SparseResidency());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpImageSparseFetch) {
            SPIRVOpImageSparseFetch otherInst = (SPIRVOpImageSparseFetch) other;
