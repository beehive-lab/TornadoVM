...
public class SPIRVOpExecutionMode extends SPIRVExecutionModeInst {
    public final SPIRVId _entryPoint;
    public final SPIRVExecutionMode _mode;

    public SPIRVOpExecutionMode(SPIRVId _entryPoint, SPIRVExecutionMode _mode) {
        super(16, _entryPoint.getWordCount() + _mode.getWordCount() + 1, "OpExecutionMode");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpExecutionMode) {
            SPIRVOpExecutionMode otherInst = (SPIRVOpExecutionMode) other;
