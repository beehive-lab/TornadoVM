...
public class SPIRVOpSNegate extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _operand;

    public SPIRVOpSNegate(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _operand) {
        super(126, _idResultType.getWordCount() + _idResult.getWordCount() + _operand.getWordCount() + 1, "OpSNegate");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpSNegate) {
            SPIRVOpSNegate otherInst = (SPIRVOpSNegate) other;
