...
public class SPIRVOpFNegate extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _operand;

    public SPIRVOpFNegate(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _operand) {
        super(127, _idResultType.getWordCount() + _idResult.getWordCount() + _operand.getWordCount() + 1, "OpFNegate");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpFNegate) {
            SPIRVOpFNegate otherInst = (SPIRVOpFNegate) other;
