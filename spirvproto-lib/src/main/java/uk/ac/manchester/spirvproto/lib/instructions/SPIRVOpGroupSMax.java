...
public class SPIRVOpGroupSMax extends SPIRVInstruction {
    ...
    public SPIRVOpGroupSMax(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVGroupOperation _operation, SPIRVId _x) {
        super(271, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _operation.getWordCount() + _x.getWordCount() + 1, "OpGroupSMax", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupSMax) {
            SPIRVOpGroupSMax otherInst = (SPIRVOpGroupSMax) other;
