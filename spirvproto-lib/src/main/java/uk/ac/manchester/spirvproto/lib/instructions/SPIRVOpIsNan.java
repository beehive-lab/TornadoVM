...
public class SPIRVOpIsNan extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _x;

    public SPIRVOpIsNan(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _x) {
        super(156, _idResultType.getWordCount() + _idResult.getWordCount() + _x.getWordCount() + 1, "OpIsNan");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpIsNan) {
            SPIRVOpIsNan otherInst = (SPIRVOpIsNan) other;
