...
public class SPIRVOpUGreaterThanEqual extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _operand1;
    public final SPIRVId _operand2;

    public SPIRVOpUGreaterThanEqual(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _operand1, SPIRVId _operand2) {
        super(174, _idResultType.getWordCount() + _idResult.getWordCount() + _operand1.getWordCount() + _operand2.getWordCount() + 1, "OpUGreaterThanEqual");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpUGreaterThanEqual) {
            SPIRVOpUGreaterThanEqual otherInst = (SPIRVOpUGreaterThanEqual) other;
