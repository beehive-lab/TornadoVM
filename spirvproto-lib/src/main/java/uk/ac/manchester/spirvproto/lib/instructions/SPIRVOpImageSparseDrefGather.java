...
public class SPIRVOpImageSparseDrefGather extends SPIRVInstruction {
    ...
    public SPIRVOpImageSparseDrefGather(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _sampledImage, SPIRVId _coordinate, SPIRVId _dRef, SPIRVOptionalOperand<SPIRVImageOperands> _imageOperands) {
        super(315, _idResultType.getWordCount() + _idResult.getWordCount() + _sampledImage.getWordCount() + _coordinate.getWordCount() + _dRef.getWordCount() + _imageOperands.getWordCount() + 1, "OpImageSparseDrefGather", SPIRVCapability.SparseResidency());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpImageSparseDrefGather) {
            SPIRVOpImageSparseDrefGather otherInst = (SPIRVOpImageSparseDrefGather) other;
