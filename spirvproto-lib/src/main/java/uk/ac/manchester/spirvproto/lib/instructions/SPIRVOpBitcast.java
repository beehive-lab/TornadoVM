...
public class SPIRVOpBitcast extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _operand;

    public SPIRVOpBitcast(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _operand) {
        super(124, _idResultType.getWordCount() + _idResult.getWordCount() + _operand.getWordCount() + 1, "OpBitcast");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpBitcast) {
            SPIRVOpBitcast otherInst = (SPIRVOpBitcast) other;
