...
public class SPIRVOpAtomicLoad extends SPIRVInstruction {
    ...
    public SPIRVOpAtomicLoad(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _pointer, SPIRVId _scope, SPIRVId _semantics) {
        super(227, _idResultType.getWordCount() + _idResult.getWordCount() + _pointer.getWordCount() + _scope.getWordCount() + _semantics.getWordCount() + 1, "OpAtomicLoad");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpAtomicLoad) {
            SPIRVOpAtomicLoad otherInst = (SPIRVOpAtomicLoad) other;
