...
public class SPIRVOpDecorateStringGOOGLE extends SPIRVInstruction {
    public final SPIRVId _target;
    public final SPIRVDecoration _decoration;

    public SPIRVOpDecorateStringGOOGLE(SPIRVId _target, SPIRVDecoration _decoration) {
        super(5632, _target.getWordCount() + _decoration.getWordCount() + 1, "OpDecorateStringGOOGLE");
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpDecorateStringGOOGLE) {
            SPIRVOpDecorateStringGOOGLE otherInst = (SPIRVOpDecorateStringGOOGLE) other;
