...
public class SPIRVOpImageSparseRead extends SPIRVInstruction {
    ...
    public SPIRVOpImageSparseRead(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _image, SPIRVId _coordinate, SPIRVOptionalOperand<SPIRVImageOperands> _imageOperands) {
        super(320, _idResultType.getWordCount() + _idResult.getWordCount() + _image.getWordCount() + _coordinate.getWordCount() + _imageOperands.getWordCount() + 1, "OpImageSparseRead", SPIRVCapability.SparseResidency());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpImageSparseRead) {
            SPIRVOpImageSparseRead otherInst = (SPIRVOpImageSparseRead) other;
