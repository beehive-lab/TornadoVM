...
public class SPIRVOpGroupFMin extends SPIRVInstruction {
    ...
    public SPIRVOpGroupFMin(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVGroupOperation _operation, SPIRVId _x) {
        super(266, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _operation.getWordCount() + _x.getWordCount() + 1, "OpGroupFMin", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupFMin) {
            SPIRVOpGroupFMin otherInst = (SPIRVOpGroupFMin) other;
