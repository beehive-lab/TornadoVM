...
public class SPIRVOpGroupUMaxNonUniformAMD extends SPIRVInstruction {
    ...
    public SPIRVOpGroupUMaxNonUniformAMD(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVGroupOperation _operation, SPIRVId _x) {
        super(5006, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _operation.getWordCount() + _x.getWordCount() + 1, "OpGroupUMaxNonUniformAMD", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupUMaxNonUniformAMD) {
            SPIRVOpGroupUMaxNonUniformAMD otherInst = (SPIRVOpGroupUMaxNonUniformAMD) other;
