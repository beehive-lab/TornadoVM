...
public class SPIRVOpReservedReadPipe extends SPIRVInstruction {
    ...
    public SPIRVOpReservedReadPipe(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _pipe, SPIRVId _reserveId, SPIRVId _index, SPIRVId _pointer, SPIRVId _packetSize, SPIRVId _packetAlignment) {
        super(276, _idResultType.getWordCount() + _idResult.getWordCount() + _pipe.getWordCount() + _reserveId.getWordCount() + _index.getWordCount() + _pointer.getWordCount() + _packetSize.getWordCount() + _packetAlignment.getWordCount() + 1, "OpReservedReadPipe", SPIRVCapability.Pipes());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpReservedReadPipe) {
            SPIRVOpReservedReadPipe otherInst = (SPIRVOpReservedReadPipe) other;
