...
public class SPIRVOpCommitWritePipe extends SPIRVInstruction {
    ...
    public SPIRVOpCommitWritePipe(SPIRVId _pipe, SPIRVId _reserveId, SPIRVId _packetSize, SPIRVId _packetAlignment) {
        super(281, _pipe.getWordCount() + _reserveId.getWordCount() + _packetSize.getWordCount() + _packetAlignment.getWordCount() + 1, "OpCommitWritePipe", SPIRVCapability.Pipes());
        this._pipe = _pipe;
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpCommitWritePipe) {
            SPIRVOpCommitWritePipe otherInst = (SPIRVOpCommitWritePipe) other;
