...
public class SPIRVOpGroupAll extends SPIRVInstruction {
    public final SPIRVId _idResultType;
    public final SPIRVId _idResult;
    public final SPIRVId _execution;
    public final SPIRVId _predicate;

    public SPIRVOpGroupAll(SPIRVId _idResultType, SPIRVId _idResult, SPIRVId _execution, SPIRVId _predicate) {
        super(261, _idResultType.getWordCount() + _idResult.getWordCount() + _execution.getWordCount() + _predicate.getWordCount() + 1, "OpGroupAll", SPIRVCapability.Groups());
    ...
    public boolean equals(Object other) {
        if (other instanceof SPIRVOpGroupAll) {
            SPIRVOpGroupAll otherInst = (SPIRVOpGroupAll) other;
